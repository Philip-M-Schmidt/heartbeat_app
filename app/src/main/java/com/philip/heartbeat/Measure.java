...
public class Measure extends AppCompatActivity implements android.view.SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SurfaceView = (android.view.SurfaceView) findViewById(R.id.preview);
